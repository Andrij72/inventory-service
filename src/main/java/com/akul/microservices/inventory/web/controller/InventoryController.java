...
import com.akul.microservices.inventory.aplication.service.InventoryReservationService;
...
public class InventoryController {
    ...
    public ResponseEntity<CheckStockResponse> checkStock(@RequestParam String skuCode,
        ...
        boolean available = inventoryReservationService.isProductInStock(skuCode, quantity);
    ...
    public ResponseEntity<List<ReserveInventoryResponse>> reserve(@RequestBody ReserveInventoryRequest request) {
        List<ReserveInventoryResponse> responses = inventoryReservationService.reserve(request);
    ...
    public ResponseEntity<String> cancel(@RequestParam String orderId) {
        inventoryReservationService.cancel(orderId);
